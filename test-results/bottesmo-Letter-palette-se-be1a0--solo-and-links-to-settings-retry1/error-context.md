...
- Name: bottesmo.spec.js >> Letter palette settings >> gear icon is visible on / and /game?mode=solo and links to /settings
- Location: bottesmo.spec.js:675:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3129/
Call log:
  - navigating to "http://localhost:3129/", waiting until "load"
