...
```ts
  223 |     });
  224 |     const createData = await createResp.json();
  225 |     const code = createData.roomCode;
  226 |     const aliceID = createData.playerID;
  227 |     const aliceToken = createData.token;
  228 | 
