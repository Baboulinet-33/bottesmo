...
- Name: tusmo.spec.js >> Tusmo E2E — Match UI to real Tusmo >> 2. Backspace behavior — typed letters clear, locked letters stay
- Location: tusmo.spec.js:68:3
...
Call log:
  ...
  - waiting for locator('#tile-0-0')
    14 × locator resolved to <div id="tile-0-0" class="tile locked correct">A</div>
       - unexpected value "A"
...
```ts
  ...
  2   | 
  3   | const BASE = 'http://localhost:3106';
  4   | 
  5   | /**
  ...
  20  | }
  21  | 
  22  | test.describe('Tusmo E2E — Match UI to real Tusmo', () => {
  23  |   let targetWord = '';
  24  |   let firstLetter = '';
  25  | 
