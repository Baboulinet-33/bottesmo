...
- Name: tusmo.spec.js >> Tusmo E2E — Match UI to real Tusmo >> 1. Basic typing flow — letters fill cells, Enter/Valider submit
- Location: tusmo.spec.js:37:3
...
Call log:
  ...
  - waiting for locator('#tile-0-0')
    14 × locator resolved to <div id="tile-0-0" class="tile locked correct">E</div>
       - unexpected value "E"
